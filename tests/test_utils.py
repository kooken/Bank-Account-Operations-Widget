...
def test_hidden_numbers():
    ...
    hidden_for_account = "IBAN 64686473678894779589"
    assert utils.hidden_numbers(hidden_for_none) == "No data"
    assert utils.hidden_numbers(hidden_for_card) == "Maestro 1596 83** **** 5199"
    assert utils.hidden_numbers(hidden_for_account) == "IBAN **9589"
    ...
    for_format = [
        {
            ...
            "to": "IBAN 64686473678894779589"
        }]
    assert utils.formatted_operations(for_format) == ("26.08.2019 Business Money Transfer\n"
                                                      "Maestro 1596 83** **** 5199 -> IBAN **9589\n"
                                                      "31957.58 руб.\n")
